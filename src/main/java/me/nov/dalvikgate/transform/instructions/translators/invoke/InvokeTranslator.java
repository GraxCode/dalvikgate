...
public class InvokeTranslator extends AbstractInsnTranslator<BuilderInstruction35c> {

  public InvokeTranslator(InstructionTransformer it) {
    super(it);
  }
  ...
  public void translate(BuilderInstruction35c i, BuilderInstruction next) {
    ...
    if (i.getOpcode() == Opcode.FILLED_NEW_ARRAY) {
      translateFilledNewArray(i, next);
      return;
    }
    String owner;
    String name;
  ...
  private void translateFilledNewArray(BuilderInstruction35c i, BuilderInstruction next) {
